...
const Register: React.FC = () => {
  ...
  const onSubmit = async (data: FormData) => {
    setLoading(true);
    try {
      await signUp(data.email, data.password, data.fullName, data.role as 'user' | 'admin');
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                className="relative block w-full px-3 py-3 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500"
